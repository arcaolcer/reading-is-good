...
class OrderControllerTest {
    ...
    void createNewBookReturnSuccessTest() throws Exception {
        var request = ReadingIsGoodTestDOFactory.generateCreateNewOrderRequest();
        given(this.orderService.createNewOrder(request)).willReturn(ReadingIsGoodTestDOFactory.generateSuccessResponse());
